...
def get_exponential_decay_schedule(optimizer, num_constant_steps=6, step_decay=0.5, last_epoch=-1):
    """
    ...
    Args:
        ...
        num_constant_steps (:obj:`int`):
            The number of steps for the constant phase, no decay.
    ...
    def lr_lambda(current_step: int):
        if current_step < num_constant_steps:
            return 1.0
        return step_decay ** (current_step-num_constant_steps)
