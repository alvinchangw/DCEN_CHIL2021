...
export SPLICEAI_WEIGHTS=models/spliceai_250samples_100Klen_clsreg_2ep_dropprob_seed234/spliceai_train_checkpoint-130000/spliceai_pytorch_model.bin
export SITE_AUX_WEIGHTS=models/spliceai_250samples_100Klen_clsreg_2ep_dropprob_seed234/spliceai_train_checkpoint-130000/site_aux_pytorch_model.bin
export OUTPUT_DIR=models/onlyspliceosomeMoreLayerBaseline_250samples_100Klen_noaug_pretrained130Kregspliceai
...
python train_and_infer.py \
    ...
    --num_train_ablation_more_layers_epochs 1 \
    ...
    --spliceosome_model_type more_layers_baseline \
